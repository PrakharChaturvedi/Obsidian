...
- Explain the role of User Code in the CloudSim architecture and how it interacts with other components. How does CloudSim manage the simulation environment, and what are its core functions? What is the function of GridSim in CloudSim, and how does it extend the capabilities of CloudSim? 
- Describe SimJava and its relevance to the overall CloudSim architecture. How does SimJava's event-driven model work within CloudSim?